...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('landing_kelas_industri/style/revolution/css/layers.css') }}">
    <link rel="stylesheet" type="text/css"
    ...
    <div class="content-wrapper">
                    ...
                    <ul>
                        <li data-transition="fade" data-thumb=""><img
                            ...
                            <div class="tp-caption font-weight-300 color-dark"
                                ...
                                sekolah guru mentor serta murit untuk meningkatkan keefektif dalam mengajar serta belajar
                            ...
                            <a class="tp-caption btn btn-l btn-default" data-x="['left','left','left','center']"
                                ...
                                data-frames='[{"delay":2000,"speed":1200,"frame":"0","from":"y:50px;opacity:0;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;","ease":"Power3.easeInOut"}]'
                                data-responsive="on" data-responsive_offset="on" style="z-index: 9;"
                                href="{{route('login')}}">Try It For Free
                            </a>
                            @endauth
            ...
            <div class="container inner pt-100">
                ...
                <div class="row text-center gutter-60">
                    <div class="col-md-6 col-lg-3">
                        <div class="icon icon-blob icon-blob-rose color-rose mb-20"> <i class="jam jam-search"></i>
                        </div>
                        <h5>Mentor</h5>
                        <p>Terdapat banyak mentor yang sudah memiliki banyak pengalaman dan prestasi.
                        </p>
                    </div>
                    <!--/column -->
                    <div class="col-md-6 col-lg-3">
                        <div class="icon icon-blob icon-blob-blue color-blue mb-20"> <i class="jam jam-layout"></i>
                        </div>
                        <h5>Materi</h5>
                        <p>Terdapat banyak materi yang
                        </p>
                    </div>
                    <!--/column -->
        ...
        <div class="wrapper light-wrapper">
            <div class="container inner">
                ...
                <h3 class="display-3 text-center">Customer satisfaction is our major goal. <br
                        class="d-none d-lg-block" />See
                    what our customers are saying about us.</h3>
                <div class="space20"></div>
                <div class="grid-view">
                    <div class="carousel owl-carousel gap-small" data-margin="0" data-dots="true"
                                ...
                                <div class="box bg-white shadow">
                                    <blockquote>
                                        ...
                                        <div class="blockquote-details">
                                            <div class="img-blob blob1"><img
                                                    src="{{ asset('landing_kelas_industri/style/images/art/t1.jpg') }}"
                                                    alt="" /></div>
                                            <div class="info">
                            ...
                            <div class="item-inner">
                                <div class="box bg-white shadow">
                                    <blockquote>
                                        ...
                                        <div class="blockquote-details">
                                            <div class="img-blob blob1"><img
                                                    src="{{ asset('landing_kelas_industri/style/images/art/t2.jpg') }}"
                                                    alt="" /></div>
                                            <div class="info">
                            ...
                            <div class="item-inner">
                                <div class="box bg-white shadow">
                                    <blockquote>
                                        ...
                                        <div class="blockquote-details">
                                            <div class="img-blob blob1"><img
                                                    src="{{ asset('landing_kelas_industri/style/images/art/t3.jpg') }}"
                                                    alt="" /></div>
                                            <div class="info">
                        ...
                        <div class="item">
                            <div class="item-inner">
                                <div class="box bg-white shadow">
                                    <blockquote>
                                        <p>"Curabitur blandit tempus porttitor. Integer posuere erat a ante venenatis
                                            dapibus posuere velit
                                            aliquet. Duis mollis, est non commodo luctus."</p>
                                        <div class="blockquote-details">
                                            <div class="img-blob blob1"><img
                                                    src="{{ asset('landing_kelas_industri/style/images/art/t4.jpg') }}"
                                                    alt="" /></div>
                                            <div class="info">
                        ...
                        <div class="item">
                            <div class="item-inner">
                                <div class="box bg-white shadow">
                                    <blockquote>
                                        <p>"Aenean lacinia bibendum nulla sed consectetur. Cum sociis natoque penatibus
                                            et magnis dis
                                            parturient montes, nascetur ridiculus mus vestibulum."</p>
                                        <div class="blockquote-details">
                                            <div class="img-blob blob1"><img
                                                    src="{{ asset('landing_kelas_industri/style/images/art/t5.jpg') }}"
                                                    alt="" /></div>
                                            <div class="info">
                        ...
                        <div class="item">
                            <div class="item-inner">
                                <div class="box bg-white shadow">
                                    <blockquote>
                                        <p>"Donec sed odio dui. Cras mattis consectetur purus sit amet fermentum. Aenean
                                            eu leo quam.
                                            Pellentesque ornare sem lacinia quam venenatis."</p>
                                        <div class="blockquote-details">
                                            <div class="img-blob blob1"><img
                                                    src="{{ asset('landing_kelas_industri/style/images/art/t6.jpg') }}"
                                                    alt="" /></div>
                                            <div class="info">
                ...
                <div class="row">
                    <div class="col-lg-5 pr-50 pr-md-15">
                        ...
                        <p>Nulla vitae elit libero, a pharetra augue. Donec ullamcorper nulla non metus auctor
                            fringilla. Maecenas
                            sed diam eget risus varius blandit sit amet non magna. Nulla vitae elit libero, a pharetra
                            augue. Cras
                        ...
                        <form class="fields-white">
                            <div class="input-group">
                                <input type="email" value="" name="EMAIL"
                                    class="email form-control mb-0 mr-2 mb-sm-0" placeholder="Email Address" required>
                                <button type="submit"
                            ...
                            <ul class="image-list">
                                <li>
                                    ...
                                    <div class="post-content">
                                        <h6 class="post-title"> <a href="blog-post.html">Magna Mollis Ultricies</a>
                                        </h6>
