...
<body id="kt_body" class="app-blank bgi-size-cover bgi-position-center bgi-no-repeat">
    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
        ...
        <style>
            body {
                background-image: url("{{ asset('app-assets/media/auth/bg1') }}");
            }

            [data-bs-theme="dark"] body {
                background-image: url("{{ asset('app-assets/media/auth/bg1-dark.jpg') }}");
            }
        </style>
        <!--end::Page bg image-->
                ...
                <div class="card card-flush w-lg-650px py-5">
                    <div class="card-body py-15 py-lg-20">
                        ...
                        <div class="fw-semibold fs-4 text-gray-500 mb-7">
                            ...
                            Kamu belum menyelesaikan tugas dan kuis dari materi sebelumnya
                        </div>
                        <!--end::Text-->

                        <!--begin::Illustration-->
                        <div class="mb-3">
                            {{-- <img src="{{ asset('app-assets/media/auth/404-error.png') }}"
                                class="mw-100 mh-300px theme-light-show" alt="" />
                            <img src="{{ asset('app-assets/media/auth/404-error-dark.png') }}"
