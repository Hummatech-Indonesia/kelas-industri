            ...
            <div class="container flex-row justify-content-center">
                ...
                <div class="navbar-collapse offcanvas-nav">
                    ...
                    <ul class="navbar-nav mx-auto">
                        ...
                        <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="{{route('landingPage', '#5')}}">LMS</a>
                        </li>
                        <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="{{route('landingPage', '#6')}}">Daftar</a>
                        </li>
