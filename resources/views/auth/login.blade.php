    ...
    <div class="d-flex flex-column flex-lg-row flex-column-fluid">
        ...
        <div class="d-flex flex-lg-row-fluid">
            ...
            <div class="d-flex flex-column flex-center pb-0 pb-lg-10 p-10 w-100">
                <!--begin::Image-->
                <img class="theme-light-show mx-auto mw-100 w-150px w-lg-300px mb-10 mb-lg-20" src="{{asset('app-assets/media/auth/agency.png')}}" alt=""/>
                <img class="theme-dark-show mx-auto mw-100 w-150px w-lg-300px mb-10 mb-lg-20" src="{{ asset('app-assets/media/auth/agency-dark.png') }}" alt=""/>
                <!--end::Image-->
            ...
            <div class="bg-body d-flex flex-column flex-center rounded-4 w-md-600px p-10">
                ...
                <div class="d-flex flex-center flex-column align-items-stretch h-lg-100 w-md-400px">
                    ...
                    <div class="d-flex flex-center flex-column-fluid pb-15 pb-lg-20">
                        ...
                        <!--begin::Form-->
                        <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" data-kt-redirect-url="/metronic8/demo7/../demo7/index.html" method="POST" action="{{ route('login') }}">
                            @csrf
                            <!--begin::Heading-->
