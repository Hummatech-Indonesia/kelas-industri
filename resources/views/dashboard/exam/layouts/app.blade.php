...
<body id="kt_app_body" data-kt-app-header-fixed="true" data-kt-app-header-fixed-mobile="true"
    ...
    data-kt-app-sidebar-secondary-enabled="true" ondragstart="return false;" ondrop="return false;" class="app-default">
    ...
    <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
        ...
        <div class="app-page  flex-column flex-column-fluid " id="kt_app_page">
            ...
            <!--begin::Header-->
            @include('dashboard.exam.layouts.navbar')
            <!--end::Header-->
            <!--begin::Wrapper-->
            <div class="app-wrapper ms-0 flex-column flex-row-fluid " id="kt_app_wrapper">
