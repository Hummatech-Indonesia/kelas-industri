...
@section('content')
    <div class="toolbar mb-5 mb-lg-7" id="kt_toolbar">
        ...
        <div class="d-flex align-items-center gap-2 gap-lg-3">
            <a href="{{ route('administration.gajiGuru.create') }}" class="btn btn-dark fw-bold h-40px fs-7">
                Tambah
            </a>
        </div>
    </div>
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                {{-- @foreach ($salarys as $salary) --}}
                                    <tr>
                                        ...
                                        <td><a href="
                                            {{-- {{route('admin.editSaleriesTeacher', $salary->id)}} --}}
