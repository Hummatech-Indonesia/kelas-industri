                ...
                <div id="kt_app_content_container" class="app-container  container-fluid ">
                    ...
                    <div class="row row-gap-5">
                        @if (auth()->user()->roles->pluck('name')[0] == 'student')
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="d-flex flex-column me-auto">
                                                ...
                                                <a href="#"
                                                    class="card-title text-black fw-semibold text-hover-primary font-weight-bolder font-size-h6 text-dark mb-1">

                                                    PRE TEST
                                                </a>

                                                <span class="text-muted font-weight-bold">
                                                    Evaluasi awal materi
                                                </span>
                                        ...
                                        <div class="mt-3">
                                            <span class="text-black fw-semibold d-flex">
                                                ...
                                                Waktu : {{ $material->materialExam->time }} Menit
                                            </span>

                                        </div>
                                        <div class="mt-3">
                                            <span class="text-black fw-semibold d-flex">
                                                <svg width="19" height="19" class="me-2" viewBox="0 0 20 20"
                                                ...
                                                Soal :
                                                {{ $material->materialExam->total_essay + $material->materialExam->total_multiple_choice }}
                                            </span>
                                        ...
                                        <div class="col-xl-4 mb-3">
                                            ...
                                            <div class="card card-custom gutter-b card-stretch">
                                                ...
                                                <div class="card-footer d-flex flex-row justify-content-between">
                                                    ...
                                                    @else
                                                        <button
                                                            class="btn btn-secondary btn-sm text-uppercase font-weight-bolder mt-5 mt-sm-0 mr-auto mr-sm-0 ml-sm-auto"
                            ...
                            @endforelse
                            @if ($countAllSubMaterialQuiz == $countAllStudentSubMaterialQuiz)
                                <div class="col-xl-4 mb-3">
                                        ...
                                        <div class="card-footer d-flex flex-row justify-content-center">
                                            ...
                                            @if ($studentMaterialId)
                                                <a href="{{ route('student.exam.show-finish-exam-material', ['materialExam' => $material->exam->id, 'studentMaterialExam' => $studentMaterialId->id]) }}"
                                                    ...
                                                    Hasil</a>
                                            @else
                                                <a href="{{ route('student.material-exam', ['materialExam' => $material->exam->id, 'type' => MaterialExamTypeEnum::POSTEST->value]) }}"
                                                    class="btn btn-primary btn-sm text-uppercase font-weight-bolder mt-5 mt-sm-0 mr-auto mr-sm-0 ml-sm-auto">Mulai
                                                    Post Test</a>
                                            @endif
