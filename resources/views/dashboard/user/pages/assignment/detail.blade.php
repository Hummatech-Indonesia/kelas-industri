                    ...
                    <div id="kt_app_toolbar_container" class="app-container  container-fluid d-flex flex-stack flex-wrap ">
                        ...
                        <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                            ...
                            <div class="d-flex align-items-center gap-2 gap-lg-3">
                                @if ($submitAssignment && !$submitAssignment->is_rated)
                                                ...
                                                <div class="form-grup row mb-3">
                                                    @if ($assignment->end_date > now())
                                                        <div class="form-grup row mb-3">
                                                            ...
                                                            <div class="alert alert-danger d-flex align-items-center p-5">
                                                                ...
                                                                <div class="d-flex flex-column">
                                                                    ...
                                                                    <ul>
                                                                        <li>
                                                                            Pastikan Tugas Anda Sudah Ada Dengan
                                                                            MenDownloadnya,
                                                        ...
                                                        <div class="alert alert-warning d-flex align-items-center p-5">
                                                            ...
                                                            <span class="svg-icon svg-icon-2hx svg-icon-primary me-3">
                                                                <span
                                                                    class="svg-icon svg-icon-2hx svg-icon-warning me-4"><svg
                                                            ...
                                                            <div class="d-flex flex-column">
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li>File yang tersedia adalah file yang telah dikirim.
                                                                    </li>
                                                                    <li>Jika file belum tersedia maka anda belum
                                                                        mengumpulkan
                                                                        tugas.
                                                                    </li>
                                                                    <li>File yang diinputkan harus ekstensi rar/zip atau
                                                                        png,
                                                                        jpg, jpeg.</li>
                                                                    <li>Jumlah maksimal 10 file</li>
                                                                    <li>Link harus berupa url yang berisi repository tugas
                                                                        anda
                                                                    </li>
                                                                </ul>
                                                                <!--end::Content-->
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="dropzone mt-5" id="kt_dropzonejs_example_1">
                                                        ...
                                                        <div class="dz-message needsclick">
                                                            ...
                                                            <!--begin::Info-->
                                                            <div class="ms-4">
                                                                <h3 class="fs-5 fw-bold text-gray-900 mb-1">Drop file atau
                                                                    klik
                                            ...
                                            @else
                                                <div class="col-12 text-center">
                                                    ...
                                                    <span class="fw-semibold text-gray-700 mb-4 d-block">
                                                        Tugas sudah ditutup, anda bisa download tugas anda jika tersedia,
                                                        jika
        ...
        <div class="col-12">
            ...
            <div class="card card-custom card-sticky" id="kt_page_sticky_card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="image">
                            @if ($submitAssignment->images->count() > 1)
                                <a href="{{ Route('student.downloadAssignment', ['submitAssignment' => $submitAssignment->id]) }}"
                                    class="btn btn-dark fw-bold btn-sm">
                                    <span class="svg-icon svg-icon-muted svg-icon-1"><svg width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            @else
                                {{-- @dd(asset('storage/' . $submitAssignment->images->first()->image)) --}}
                                <img src="{{ asset('storage/' . $submitAssignment->images->first()->image) }}"
                                    alt="asdfsdf" style="max-width: 100%">
                            @endif
                        </div>
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-lg-9 col-xl-9">
                                ...
                                <a href="http://{{ $submitAssignment->link }}" target="_blank"
                                    rel="noopener noreferrer">{{ $submitAssignment->link }}</a>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <label class="col-xl-3 col-lg-3 col-form-label">Nilai: </label>

                            <div class="col-lg-9 col-xl-9">

                                <p>{{ $submitAssignment->point }}</p>
