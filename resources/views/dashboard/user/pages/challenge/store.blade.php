            ...
            <div id="kt_app_content" class="app-content  flex-column-fluid ">
                ...
                <div id="kt_app_content_container" class="app-container  container-fluid ">
                    ...
                    <div class="row">
                        ...
                        <form
                            action="{{ route('student.storeChallenge') }}"
                                            ...
                                            <div class="form-grup row mb-3">
                                                <div class="alert alert-warning d-flex align-items-center p-5">
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        ...
                                                        <!--begin::Content-->
                                                        <ul>
                                                            <li>Jika anda mengupload file tantangan baru maka file tantangan lama akan terhapus.
                                                            </li>
                                                            <li>File yang tersedia adalah file yang telah dikirim.</li>
                                                            <li>Jika file belum tersedia maka anda belum mengumpulkan tantangan.</li>
