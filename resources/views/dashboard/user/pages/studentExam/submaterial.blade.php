        ...
        <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_content" class="app-content  flex-column-fluid ">
                    ...
                    <div id="kt_app_toolbar_container" class="app-container  container-fluid d-flex flex-stack flex-wrap ">
                        ...
                        <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                            ...
                            <div class="d-flex align-items-center gap-2 gap-lg-3">
                                ...
                                <a href="{{ route('student.exams.showMaterial', $parameters['material']) }}"
                ...
                <div id="kt_app_content_container" class="app-container  container-fluid ">
                    ...
                    <div class="row">
                        <form
                            action="{{ route('student.exams.showMaterial', ['material' => $material]) }}">
                            <!--begin::Card-->
                            <div class="card mb-7">
                                <!--begin::Card body-->
                                <div class="card-body">
                                    ...
                                    <div class="searching align-items-center">
                                        ...
                                        <div class="col-lg-2 col-md-12">
                                            ...
                                            <a href="{{ route('student.exams.showMaterial', ['material' => $material]) }}"
                                    ...
                                    <div class="col-xl-4 mb-3">
                                        ...
                                        <div class="card card-custom gutter-b card-stretch">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-shrink-0 mr-4 symbol symbol-65 symbol-circle me-5">
                                                        ...
                                                        <span
                                                            class="font-size-h5 symbol-label bg-primary text-inverse-primary h1 font-weight-boldest">{{ substr($infos->title, 0, 1) }}</span>
                                            ...
                                            <div class="card-footer d-flex flex-row justify-content-between">
                                                ...
                                                <a href="{{ route('student.exams.show', $infos->id) }}"
                                                    class="btn btn-primary btn-sm text-uppercase font-weight-bolder mt-5 mt-sm-0 mr-auto mr-sm-0 ml-sm-auto">Masuk Ujian</a>
                                                ...
                                                <div class="card-footer d-flex flex-row justify-content-between">
                                                    <div class="d-flex">
                                                        <div class="d-flex align-items-center me-5">
                                                            ...
                                                            <!--end::Svg Icon-->
                                                            <a href="#"
                                                                class="fw-bold text-info ml-2">{{ count($infos->assignments) }}
                                                                Tugas</a>
