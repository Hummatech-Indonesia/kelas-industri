                ...
                <div class="content fs-3">
                    <div class="row mt-3">
                        ...
                        <div class="col col-sm-9"><span class="me-1">:
                                </span><span class="fs-5">{{ Carbon::parse($materialExam->start_at)->locale('id')->isoFormat('dddd, DD MMMM YYYY, HH:ss') }}</span>
                        </div>
                    </div>
                    <div class="row mt-3">
                    ...
                    <a href=
                    "{{ route('student.materials', ['classroom' => auth()->user()->studentSchool->studentClassroom->classroom->id]) }}"
