                            ...
                            <div class="tab-pane fade show {{ $index == 0 ? 'active' : '' }}"
                                ...
                                <div class="card-footer py-5 mt-5">
                                    <div class="d-flex justify-content-end">
                                        <div class="d-flex justify-content-evenly gap-3 text-dark">
                                            <span
                                            ...
                                            <span class="prev svg-icon svg-icon-dark svg-icon-2hx bg-primary rounded"
                                            ...
                                            @else
                                                <span data-question="{{ $index }}"
                                                    ...
                                                    class="next svg-icon svg-icon-dark svg-icon-2hx bg-primary rounded"
                                                    data-index="{{ $index + 1 }}"
