        ...
        <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_content" class="app-content  flex-column-fluid ">
                ...
                <div id="kt_app_content_container" class="app-container  container-fluid ">
                    ...
                    <div class="row">
                        @role('student')
                            <form action="{{ route('student.materials', ['classroom' => $classroom]) }}">
                            @else
                        ...
                        <div class="row">
                            @if (auth()->user()->roles->pluck('name')[0] == 'student')
                                ...
                                @forelse ($materials as $key => $material)
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="d-flex flex-column me-auto">
                                                            ...
                                                            <div
                                                                class="card-title font-weight-bolder font-size-h6 text-dark mb-1">
                                                                {{ $material->title }}
                                                            </div>
                                                            {{-- </a> --}}
                                    ...
                                    @else
                                        @php
                                            $prevMaterialComplete = $materials[
                                                $key - 1
                                            ]->materialExam->studentMaterialExams
                                                ->where('student_id', auth()->user()->id)
                                        ...
                                        <div class="col-xl-4 mb-5">
                                            ...
                                            <div
                                                ...
                                                @if (!$prevMaterialComplete) card-disabled @endif
