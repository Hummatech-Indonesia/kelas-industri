@php
    ...
    $notificationController = new \App\Http\Controllers\NotificationController($notificationService);
                        ...
                        @if (auth()->user()->roles->pluck('name')[0] == 'teacher')
                            <div class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2">
                                ...
                                <a href="{{ route('teacher.submaterialExam.index') }}"
                                    class="menu-link {{ request()->routeIs('mentor.submaterialExam.index') || request()->routeIs('teacher.detailSubMaterialExam') ? 'active' : '' }}">
