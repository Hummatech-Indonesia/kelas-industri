...
@section('content')
    <div class="toolbar mb-5 mb-lg-7" id="kt_toolbar">
        ...
        <div class="d-flex align-items-center gap-2 gap-lg-3">
            <a href="{{ route('admin.saleries.create') }}" class="btn btn-dark fw-bold h-40px fs-7">
                Tambah
            </a>
        </div>
    </div>
                                ...
                                <tbody class="fw-semibold text-gray-600">
                                    @foreach ($salarys as $salery)
                                        <tr>
                                            ...
                                            <td><a href="{{ route('admin.saleries.edit', [$salery->id]) }}"
                                                    class="btn btn-default btn-sm p-1"><i
                                                        class="fonticon-setting fs-2 text-warning"></i></a>
                                                <button class="btn btn-default btn-sm p-1 btn-delete" data-id="{{$salery->id}}">
