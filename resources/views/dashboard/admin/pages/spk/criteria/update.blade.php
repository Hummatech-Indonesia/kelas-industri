...
@section('content')
    ...
    <div class="content flex-column-fluid" id="kt_content">
        <div class="row">
            <div class="col-12">
                <form action="{{ route('admin.spk.criteria.update',['criterion' => $criterion->id]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="col-12">
                                    ...
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            ...
                                            <input class="form-control form-control-solid form-control-lg" name="name"
                                                type="text" value="{{ old('name') ? old('name') : $criterion->name }}"
                                    ...
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            ...
                                            <input class="form-control form-control-solid form-control-lg" name="weight"
                                                type="number" value="{{ old('weight') ? old('weight') : $criterion->weight }}"
