...
@section('content')
    <div class="toolbar mb-5 mb-lg-7" id="kt_toolbar">
        ...
        <div class="d-flex align-items-center gap-2 gap-lg-3">
            <a href="{{ route('admin.createSaleriesTeacher') }}" class="btn btn-dark fw-bold h-40px fs-7">
                Tambah
            </a>
        </div>
    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <svg fill="#474761" xmlns="http://www.w3.org/2000/svg" height="30"
                                                viewBox="0 0 24 24" data-photo="{{asset('storage/'.$salary->photo)}}" class="btn-photo" >
                                                <path
                                                    d="M8.5 13.498l2.5 3.006l3.5-4.506l4.5 6H5m16 1v-14a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2z"
                                                    fill="currentColor" />
                                            </svg>
                                        </td>
                                        <td><a href="{{route('admin.editSaleriesTeacher', $salary->id)}}" class="btn btn-default btn-sm p-1"><i
                                                    class="fonticon-setting fs-2 text-warning"></i></a>
                                            <button class="btn btn-default btn-sm p-1 btn-delete" data-id="{{$salary->id}}">
