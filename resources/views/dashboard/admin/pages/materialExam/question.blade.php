...
@section('content')
    <div class="toolbar mb-5 mb-lg-7" id="kt_toolbar">
        ...
        <div class="page-title d-flex justify-content-start">
            <!--begin::Title-->
            <div class="">
                <a href="{{ route('admin.material-exam-question-manual', ['material' => $materialExam->material_id, 'materialExam' => $materialExam->id]) }}"
        ...
        <div class="d-flex align-items-center gap-2 gap-lg-3">
            <a href="{{ route('admin.material-exam.index') }}"
    ...
    <div class="modal fade" tabindex="-1" id="kt_modal_create">
        <div class="modal-dialog modal-md">
            <form action="{{ route('admin.material-questionBank.auto', $materialExam->id) }}" method="post">
                @method('POST')
                @csrf
