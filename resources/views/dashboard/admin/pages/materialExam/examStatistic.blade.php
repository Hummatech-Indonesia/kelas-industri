    ...
    <div class="toolbar mb-5 mb-lg-7" id="kt_toolbar">
        ...
        <div class="page-title d-flex flex-column justify-content-between">
            ...
            <h1 class="d-flex text-dark fw-bold my-1 fs-3">
                Statistik Test Ujian Materi Selesai
            </h1>
            <!--end::Title-->

            <!--begin::Breadcrumb-->
            <p class="text-muted">
                Daftar Statistik Test Ujian Yang Sudah Selesai
            </p>
            <!--end::Breadcrumb-->
        </div>
    </div>
                    ...
                    <a href="#" class="card hover-elevate-up col shadow-sm parent-hover">
                        <div class="card-body d-flex align-items">
                            ...
                            <span class="ms-3 text-gray-700 parent-hover-primary fs-6 fw-bold my-auto">
                                Siswa Mengerjakan <span>{{ count($studentExams) }}</span>
                            </span>
                        </div>
                    </a>
                    <a href="#" class="card hover-elevate-up col shadow-sm parent-hover">
                        <div class="card-body d-flex align-items">
                            <span class="w-4 h-4 my-auto fs-1">
                                <svg width="30" height="30" viewBox="0 0 41 38" fill="none"
                                    ...
                                    <path
                                        ...
                                        stroke="#009EF7" stroke-width="3.5" stroke-linecap="round"
                            ...
                            <span class="ms-3 text-gray-700 parent-hover-primary fs-6 fw-bold my-auto">
                                Rata-Rata Nilai
                                <span>{{ $studentExams->avg('score') }}</span>
                                        ...
                                        <div class="d-flex justify-content-between mt-2">
                                            <div class="d-flex justify-content-header">
                                                <div class="">
                                                    <div
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="35"
                                                            height="35" viewBox="0 0 44 44" fill="none">
                                                            <path
                                                ...
                                                <div class="">
                                                    ...
                                                    <span
                                                        class="fs-6 fw-semibold">{{ $classroom['school']['name'] }}</span>
                                                </div>
                                            </div>
                                            <div
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <a class="btn w-100 btn-md btn-primary"
                                            href="{{ route('admin.exam-material-detail-student', ['materialExam' => $materialExam->id, 'type' => MaterialExamTypeEnum::PRETEST->value]) }}">Lihat
                                            Selengkapnya</a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="covercard row gap-2">
                    <a href="#" class="card hover-elevate-up col shadow-sm parent-hover">
                        <div class="card-body d-flex align-items">
                            ...
                            <span class="ms-3 text-gray-700 parent-hover-primary fs-6 fw-bold my-auto">
                                Siswa Mengerjakan <span>{{ count($postExams) ?? '-' }}</span>
                            </span>
                        </div>
                    </a>
                    <a href="#" class="card hover-elevate-up col shadow-sm parent-hover">
                    ...
                    <a href="#" class="card hover-elevate-up col shadow-sm parent-hover">
                        <div class="card-body d-flex align-items">
                            ...
                            <span class="ms-3 text-gray-700 parent-hover-primary fs-6 fw-bold my-auto">
                                Nilai Tertinggi
                                <span>{{ $postExams->first()->score ?? '-' }}</span>
                            </span>
                        </div>
                    </a>
                    <a href="#" class="card hover-elevate-up col shadow-sm parent-hover">
                        <div class="card-body d-flex align-items">
                            ...
                            <span class="ms-3 text-gray-700 parent-hover-primary fs-6 fw-bold my-auto">
                                Nilai Terendah
                                <span>{{ $postExams->sortBy('score')->first()->score ?? '-' }}</span>
                            </span>
                        </div>
                    </a>
                </div>
                    ...
                    <div class="col-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <!--begin::Item-->
                                <div id="rangking">
                                    @forelse ($avgPostScoreClassrooms as $index => $classroom)
                                        <div class="d-flex justify-content-between mt-2">
                                            <div class="d-flex justify-content-header">
                                                <div class="">
                                                    <div
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <a class="btn w-100 btn-md btn-primary"
                                            href="{{ route('admin.exam-material-detail-student', ['materialExam' => $materialExam->id, 'type' => MaterialExamTypeEnum::POSTEST->value]) }}">Lihat
                                            Selengkapnya</a>
                                    </div>
                                </div>
                            </div>
...
@section('script')
    <script>
        $('.nav-pills .nav-item .nav-link').click(function() {
            sessionStorage.setItem('material-exam-statistic-active', $(this).data('id'));
        });
        ...
        $(document).ready(function() {
            ...
            if(!active) {
                ...
                var tabPost = $(`.nav-pills .nav-item .nav-link[data-id="${active}"]`).addClass('active');
                $(`${tabPost.attr('href')}`).addClass('show')
                $(`${tabPost.attr('href')}`).addClass('active')
            }
        })
    </script>
@endsection
