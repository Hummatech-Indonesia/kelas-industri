                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group row mb-3">
                                    ...
                                    <label class="col-xl-3 col-lg-3 col-form-label required">Judul</label>

                                    <div class="col-lg-9 col-xl-9">

                                        <input class="form-control form-control-solid form-control-lg" name="title"
                                            type="text" value="{{ old('title') }}" placeholder="Fundamental Java"
                                            required="">
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <label class="col-xl-3 col-lg-3 col-form-label required">Divisi</label>
                                        ...
                                        <select name="devision_id" class="form-select form-select-solid me-5"
                                            ...
                                            @foreach ($devisions as $devision)
                                                <option {{ old('devision_id') == $devision->id ? 'selected' : '' }}
                                                    value="{{ $devision->id }}">{{ $devision->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <label class="col-xl-3 col-lg-3 col-form-label required">Angkatan</label>
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <label class="col-xl-3 col-lg-3 col-form-label required">Deskripsi</label>
                        ...
                        <div class="card-header">
                            <div class="card-title">
                                ...
                                <h3 class="card-label">
                                    ...
                                    Silakan Isi Data Pre dan Post Test Materi
                                    ...
                                    <div class="form-check form-switch col-6">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div data-bs-toggle="tooltip" class="ms-2 mb-2" data-bs-placement="top"
                                                ...
                                                data-bs-title="*Jika aktif maka siswa hanya bisa mengumpulan 5 menit sebelum Tes berakhir">
