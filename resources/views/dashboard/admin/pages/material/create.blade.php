                            ...
                            <div class="row">
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-lg-9 col-xl-9">
                                        ...
                                        <select name="devision_id" class="form-select form-select-solid me-5" data-control="select2" data-placeholder="Select an option">
                                            @foreach($devisions as $devision)
                                                <option {{ (old('devision_id') == $devision->id) ? 'selected' : '' }} value="{{ $devision->id }}">{{ $devision->name }}</option>
                                            @endforeach
                                        </select>
