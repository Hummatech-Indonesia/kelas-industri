...
@section('content')
    ...
    <div class="content flex-column-fluid" id="kt_content">
        <div class="row">
            <form action="{{ route('admin.students.store', $school->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="col-12">
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-lg-9 col-xl-9">
                                        ...
                                        <textarea class="form-control form-control-solid form-control-lg" name="address" type="text"
                                            placeholder="Jl. Soekarno Hatta No 9" required="">{{ old('address') }}</textarea>
