...
@section('content')
    <div class="toolbar mb-5 mb-lg-7" id="kt_toolbar">
        ...
        <div class="page-title d-flex flex-column justify-content-between">
            ...
            <!--begin::Breadcrumb-->
            <p class="text-muted">
                Daftar List Sertifikasi Yang Sudah Selesai
            </p>
            <!--end::Breadcrumb-->
        </div>
    </div>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex flex-column me-auto">
                                    ...
                                    <span class="text-black fw-semibold d-flex fs-6 mb-3 text-dark">
                                        <svg class="me-2 text-dark" width="19" height="19" viewBox="0 0 20 20"
                                    ...
                                    <span class="text-black fw-semibold d-flex fs-6 mb-3 text-dark">
                                        <svg width="19" height="19" class="me-2 text-dark" viewBox="0 0 20 20"
                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                    ...
                                    <span class="text-black fw-semibold d-flex fs-6 mb-3 text-dark">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="me-2 text-dark" width="20"
                                    ...
                                    <span class="text-black fw-semibold d-flex fs-6 text-dark">
                                        <svg width="19" height="19" class="me-2 text-dark" viewBox="0 0 20 20"
                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
