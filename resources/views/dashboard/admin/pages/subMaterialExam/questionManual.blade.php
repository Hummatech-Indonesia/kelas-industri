    ...
    <div class="content flex-column-fluid" id="kt_content">
        <form action="{{ route('admin.questionBank.manual', $submaterialExam->id) }}" method="post">
            ...
            <div class="page-title d-flex justify-content-between mb-5">
                ...
                <a href="{{ route('admin.exam-question', $submaterialExam->id) }}"
            ...
            <div class="content flex-column-fluid" id="kt_content">
                        ...
                        <div class="card bg-primary">
                            <div class="card-body">
                                <div class="text-white fs-4">
                                    Pilih soal manual untuk ujian soal {{ $submaterialExam->title }}
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row mt-5">
                    @forelse ($subMaterialQuestions as $subMaterialQuestion)
                        @if ($subMaterialQuestion->type == 'multiple_choice')
                                        ...
                                        <div
                                            ...
                                            <div>
                                                ...
                                                <div class="text-black d-flex justify-content-start mb-5">
                                                    {!! $subMaterialQuestion->question !!}
                                                </div>
                                                <div class="d-flex justify-content-start text-black">
                                                    <div class="me-2">A .</div> {!! $subMaterialQuestion->option1 !!}
                                                </div>
                                                <div class="d-flex justify-content-start text-black">
                                                    <div class="me-2">B .</div>{!! $subMaterialQuestion->option2 !!}
                                                </div>
                                                <div class="d-flex justify-content-start text-black">
                                                    <div class="me-2">C .</div> {!! $subMaterialQuestion->option3 !!}
                                                </div>
                                                <div class="d-flex justify-content-start text-black">
                                                    <div class="me-2">D .</div> {!! $subMaterialQuestion->option4 !!}
                                                </div>
                                                <div class="d-flex justify-content-start text-black">
                                                    <div class="me-2">E .</div> {!! $subMaterialQuestion->option5 !!}
                                                </div>
                                            </div>
                    ...
                    @endforelse
                    {{ $subMaterialQuestions->links('pagination::bootstrap-5') }}
                </div>
        </form>
    </div>
@endsection
