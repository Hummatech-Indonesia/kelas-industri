                ...
                <div class="card card-custom gutter-b card-stretch">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-start">
                            ...
                            <div class="d-flex flex-column me-auto">
                                ...
                                <span class="text-black fw-semibold d-flex fs-6 mb-3">
                                    ...
                                    <a href="{{ route('admin.schools.show', $exam->school_id) }}">
                                        {{ $exam->school->name }}
                                    </a>
                                </span>
                                <span class="text-black fw-semibold d-flex fs-6 mb-3">
                        ...
                        <div class="d-flex justify-content-end mt-5">
                            ...
                            <a href="{{ route('admin.registerExam.result', $exam->id) }}" class="btn btn-success btn-sm">
                                Hasil
                            </a>
                        </div>
                        <!--end::Section-->
            ...
            <div class="modal-content modal-rounded">
                ...
                <div class="modal-body">
                    ...
                    <div class="stepper stepper-links d-flex flex-column" id="kt_modal_create_campaign_stepper"
                        ...
                        <!--begin::Form-->
                        <form action="{{ route('admin.registerExam.store') }}" method="POST">
                            <!--begin::Step 1-->
