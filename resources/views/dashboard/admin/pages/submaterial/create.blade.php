                            ...
                            <div class="row">
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-lg-9 col-xl-9">
                                        ...
                                        <input class="form-control form-control-solid form-control-lg" name="title" type="text" value="{{ old('title') }}" placeholder="Konsep Algoritma Pemrograman" required="">
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-lg-9 col-xl-9">
                                        ...
                                        <textarea class="form-control form-control-solid form-control-lg" rows="5" name="description" type="text" placeholder="deskripsi sub materi" required="">{{ old('description') }}</textarea>
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-lg-9 col-xl-9">
                                        ...
                                        <input class="form-control form-control-solid form-control-lg" name="student_file" type="file" value="" placeholder="password" required="">
