...
<path d="M11 19C6.55556 19 3 15.4444 3 11C3 6.55556 6.55556 3 11 3C15.4444 3 19 6.55556 19 11C19 15.4444 15.4444 19 11 19ZM11 5C7.53333 5 5 7.53333 5 11C5 14.4667 7.53333 17 11 17C14.4667 17 17 14.4667 17 11C17 7.53333 14.4667 5 11 5Z" fill="currentColor"></path>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="card-toolbar mb-7 text-end">
                                ...
                                <button type="submit" class="btn btn-sm btn-delete text-end" data-id="{{ $school->id }}" title="Hapus" data-toggle="modal" data-target="#hapus1">
    ...
    <path d="M8.82343 12.0064L8.08852 14.3348C7.8655 15.0414 8.46151 15.7366 9.19388 15.6242L11.8974 15.2092C12.4642 15.1222 12.6916 14.4278 12.2861 14.0223L9.98595 11.7221C9.61452 11.3507 8.98154 11.5055 8.82343 12.0064Z" fill="currentColor"/>
                                ...
                                <a href="{{ route('admin.schools.edit', $school->id) }}" class="fw-bold text-primary ms-2">Edit</a>
