                            ...
                            <div class="row">
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-lg-9 col-xl-9">
                                        ...
                                        <input class="form-control form-control-solid form-control-lg" name="name"
                                               type="text" value="{{ $mentor->name }}" placeholder="John Doe"
                                               required="">
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-lg-9 col-xl-9">
                                        ...
                                        <input class="form-control form-control-solid form-control-lg" name="email"
                                               type="email" value="{{ $mentor->email }}" placeholder="johndoe@gmail.com"
                                               required="">
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-lg-9 col-xl-9">
                                        ...
                                        <input class="form-control form-control-solid form-control-lg"
                                               name="phone_number"
                                               type="text" value="{{ $mentor->phone_number }}"
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-lg-9 col-xl-9">
                                        ...
                                        <input class="form-control form-control-solid form-control-lg"
                                               name="account_number"
                                               type="text" value="{{ $mentor->account_number }}"
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-lg-9 col-xl-9">
                                        ...
                                        <textarea class="form-control form-control-solid form-control-lg"
                                                  ...
                                                  required="">{{ $mentor->address }}</textarea>
