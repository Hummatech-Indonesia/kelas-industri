...
@section('content')
    <div class="toolbar mb-5 mb-lg-7" id="kt_toolbar">
        ...
        <div class="d-flex align-items-center gap-2 gap-lg-3">
            <a href="{{ route('admin.rewards.create') }}" class="btn btn-primary fw-bold h-40px fs-7">
                Tambah
            </a>
        </div>
    </div>
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                @foreach ($rewards as $reward)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('admin.rewards.edit', $reward->id)}}" class="btn btn-default btn-sm p-1"><i
                                                    class="fonticon-setting fs-2 text-warning"></i></a>
                                            <button class="btn btn-default btn-sm p-1 btn-delete" data-id="{{$reward->id}}">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">Foto Hadiah</h3>
...
@section('script')
    <script>
        ...
        $('.btn-delete').click(function() {
            const url = "{{ route('admin.rewards.destroy', ':id') }}".replace(':id', $(this).data('id'))
