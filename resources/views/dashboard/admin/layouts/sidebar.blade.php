            ...
            <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6" id="#kt_aside_menu"
                ...
                <div class="menu-item"><!--begin:Menu link-->
                    <a class="menu-link" href="https://preview.keenthemes.com/html/metronic/docs/base/utilities"
                       target="_blank">
                        <span class="menu-icon"><!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
...
<span class="svg-icon svg-icon-muted svg-icon-2x"><svg width="26" height="28" viewBox="0 0 26 28" fill="none"
                                                       xmlns="http://www.w3.org/2000/svg">
<path
...
<path d="M15 8H20L14 2V7C14 7.6 14.4 8 15 8Z" fill="currentColor"/>
                            ...
                            <span class="menu-title">Laporan</span></a><!--end:Menu link--></div>
                    <!--end:Menu item-->
                    <!--begin:Menu item-->
                    <div class="menu-item"><!--begin:Menu link-->
                        <a class="menu-link" href="https://preview.keenthemes.com/html/metronic/docs/base/utilities"
...
<path opacity="0.3" d="M22 13.1V7C22 6.4 21.6 6 21 6H14.9L22 13.1Z" fill="currentColor"/>
                            ...
                            <span class="menu-title">Peringkat</span></a><!--end:Menu link--></div>
                    <!--end:Menu item-->
                    <!--begin:Menu item-->
                    <div data-kt-menu-trigger="click"
...
<path
    ...
    fill="currentColor"/>
                            ...
                            <span class="menu-title">Absensi</span></a><!--end:Menu link--></div>
                    <!--end:Menu item-->
                @endif
    ...
    <div class="aside-footer flex-column-auto pt-5 pb-7 px-7" id="kt_aside_footer">
        <a href="https://preview.keenthemes.com/html/metronic/docs"
           ...
           title="200+ in-house components and 3rd-party plugins">
            ...
            <span class="svg-icon btn-icon svg-icon-2"><svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                            xmlns="http://www.w3.org/2000/svg">
<path opacity="0.3"
