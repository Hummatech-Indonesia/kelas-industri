      ...
      fill="currentColor"/>
        ...
        <div class="d-flex align-items-center flex-shrink-0">
            ...
            <div class="d-flex align-items-center ms-1">
                <!--begin::Menu wrapper-->
                <div
                    class="btn btn-icon btn-custom btn-icon-muted btn-active-dark btn-active-color-primary w-30px h-30px w-md-35px h-md-35px"
            ...
            <div class="d-flex align-items-center ms-1">
                ...
                <a href="#"
                   ...
                   data-kt-menu-placement="bottom-end">
                    ...
                    <span class="svg-icon theme-light-show svg-icon-2"><svg width="24" height="24" viewBox="0 0 24 24"
                                                                            fill="none"
                                                                            xmlns="http://www.w3.org/2000/svg">
<path
...
<path
    ...
    fill="currentColor"/>
                    ...
                    <span class="svg-icon theme-dark-show svg-icon-2"><svg width="24" height="24" viewBox="0 0 24 24"
                                                                           fill="none"
                                                                           xmlns="http://www.w3.org/2000/svg">
<path
