        ...
        prototype: {
            init: function (t) {
                ...
                if (!t) {
                    ...
                    }, e)), this.opts.subIndicators && (this.$subArrow = $("<span/>").addClass("sub-arrow"), this.opts.subIndicatorsText && this.$subArrow.html(this.opts.subIndicatorsText)), initMouseDetection()
                }
 ...
 */
! function (o) {
    "function" == typeof define && define.amd ? define(["jquery", "smartmenus"], o) : "object" == typeof module && "object" == typeof module.exports ? module.exports = o(require("jquery")) : o(jQuery)
}(function (r) {
    return r.extend(r.SmartMenus.Bootstrap = {}, {
        keydownFix: !1,
        init: function () {
            ...
            o.each(function () {
                var a = r(this),
                    s = a.data("smartmenus");
                if (!s) {
                    var e, t = a.is("[data-sm-skip-collapsible-behavior]");
                    a.hasClass("ml-auto") || a.prevAll(".mr-auto").length;

                    function o() {
                        a.find("a.current").each(function () {
                            var o = r(this);
                            (o.hasClass("dropdown-item") ? o : o.parent()).addClass("active")
                        }), a.find("a.has-submenu").each(function () {
                            var o = r(this);
                            o.is('[data-toggle="dropdown"]') && o.dataSM("bs-data-toggle-dropdown", !0).removeAttr("data-toggle"), !t && o.hasClass("dropdown-toggle") && o.dataSM("bs-dropdown-toggle", !0).removeClass("dropdown-toggle")
                        })
                    }

                    function n(o) {
                        var t = s.getViewportWidth();
                        (t != e || o) && (s.isCollapsible() ? a.addClass("sm-collapsible") : a.removeClass("sm-collapsible"), e = t)
                    }
                    a.smartmenus({
                        ...
                        "show.smapi": function (o, t) {
                            ...
                            e && e.css("background-color", a.css("background-color")), a.parent().addClass("show"), s.opts.keepHighlighted && 2 < a.dataSM("level") && a.prevAll("a").addClass(s.opts.bootstrapHighlightClasses)
                        },
                        "hide.smapi": function (o, t) {
                            var a = r(t);
                            a.parent().removeClass("show"), s.opts.keepHighlighted && 2 < a.dataSM("level") && a.prevAll("a").removeClass(s.opts.bootstrapHighlightClasses)
                        }
                    }), s = a.data("smartmenus"), o(), s.refresh = function () {
                        ...
                        a.find("a.current").each(function () {
                            ...
                            var o = r(this);
                            o.dataSM("bs-dropdown-toggle") && o.addClass("dropdown-toggle").removeDataSM("bs-dropdown-toggle"), o.dataSM("bs-data-toggle-dropdown") && o.attr("data-toggle", "dropdown").removeDataSM("bs-data-toggle-dropdown")
                        }), r.SmartMenus.prototype.destroy.call(this, o)
                    }, t && (s.opts.collapsibleBehavior = "toggle"), n(), r(window).on("resize.smartmenus" + s.rootId, n)
                }
            }), o.length && !r.SmartMenus.Bootstrap.keydownFix && (r(document).off("keydown.bs.dropdown.data-api", ".dropdown-menu"), r.fn.dropdown && r.fn.dropdown.Constructor && r(document).on("keydown.bs.dropdown.data-api", ".dropdown-menu.show", r.fn.dropdown.Constructor._dataApiKeydownHandler), r.SmartMenus.Bootstrap.keydownFix = !0)
        }
    }), r(r.SmartMenus.Bootstrap.init), r
});
/*-----------------------------------------------------------------------------------*/
/*	02. STICKY HEADER
/*-----------------------------------------------------------------------------------*/
...
"object" == typeof navigator && function (e, t) {
    ...
    var H, V = {
        ...
        D = {
            ...
            mime: function (e) {
                var t = e.split("https://demos.elemisthemes.com/"),
                    i = v(t, 1)[0];
    ...
    function Z(e) {
        ...
        return new Promise(function (i, n) {
            try {
                ...
                }), a.open("GET.html", e, !0), a.responseType = t, a.send()
            } catch (e) {
                n(e)
            }
        })
...
! function (a) {
    a.fn.s8CircleInfoBox = function (b) {
        var l, c = a.extend({
            ...
            k = null,
            m = !1;
        c.notResponsive && (i.addClass("noResponsive"), e.addClass("noResponsive"), d.addClass("noResponsive"));
        var o, n = function () {
                var b = 0;
                switch (g) {
                    case "left":
                ...
                d.css("height", d.width()), l = d.width() / 2, e.css("lineHeight", e.height() + "px"), e.each(function () {
                    a(this).css({
                        transform: "rotate(" + b + "deg) translate(" + l + "px) rotate(" + -1 * b + "deg)"
                    }), b += c
                })
            },
            p = function (a) {
                e.removeClass(c.hoverStyle), o = a.attr("data-cyrcleBox"), a.addClass(c.hoverStyle), i.filter("#" + o).fadeIn()
            },
            q = function (a) {
        ...
        e.on(c.action, function () {
            j == a(this).parent().index() || h || (i.fadeOut(), j = a(this).parent().index(), p(a(this)))
        }), a(window).resize(function () {
            c.responsive && !h && n(), a(window).width() < c.breakpoint ? (h = !0, m = !0, e.removeClass(c.hoverStyle), d.css("height", "auto")) : (h = !1, m = !1, null === k && c.autoSlide && s())
        ...
        7: [function (a, b, c) {
            ...
            g.prototype.animate = function (a, b, c) {
                ...
                if (this.containerAspectRatio) {
                    ...
                    e.floatEquals(this.containerAspectRatio, c / d) || (console.warn("Incorrect aspect ratio of container", "#" + a.id, "detected:", b.getPropertyValue("width") + "(width)", "https://demos.elemisthemes.com/", b.getPropertyValue("height") + "(height)", "=", c / d), console.warn("Aspect ratio of should be", this.containerAspectRatio))
                }
            }, b.exports = g
        }, {
            "./path": 5,
...
! function (a, b, c, d) {
    ...
    e.prototype = {
        ...
        detectBrowser: function () {
            ...
            a.indexOf("chrome") > -1 || a.indexOf("safari") > -1 ? (this.options.browser = "webkit", this.options.browserPrexix = "-webkit-") : a.indexOf("firefox") > -1 ? (this.options.browser = "firefox", this.options.browserPrexix = "-moz-") : -1 !== a.indexOf("MSIE") || a.indexOf("Trident/index.html") > 0 ? (this.options.browser = "ie", this.options.browserPrexix = "-ms-") : a.indexOf("Opera") > -1 && (this.options.browser = "opera", this.options.browserPrexix = "-o-")
        },
