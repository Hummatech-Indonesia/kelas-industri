...
class StudentSubmaterialExam extends Model
{
    ...
    protected $fillable = ['id', 'student_id', 'sub_material_exam_id', 'order_of_question_multiple_choice', 'order_of_question_essay', 'answer', 'deadline', 'score', 'higest_score', 'true_answer', 'finished_exam', 'finished_count'];
    protected $guarded = [];
