...
use App\Observers\MaterialExamObserver;
use App\Observers\QuestionBankObserver;
use App\Observers\SubMaterialExamObserver;
use App\Observers\StudentMaterialExamObserver;
use App\Observers\StudentSubmaterialExamObserver;
...
class EventServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        MaterialExam::observe(MaterialExamObserver::class);
        StudentMaterialExam::observe(StudentMaterialExamObserver::class);
